...
enum opt_code
{
  ...
  OPT_Waddr_space_convert = 436,             /* -Waddr-space-convert */
  ...
  OPT_Wmisspelled_isr = 659,                 /* -Wmisspelled-isr */
  ...
  OPT_list = 1765,                           /* -list */
  OPT_mabsdata = 1766,                       /* -mabsdata */
  OPT_maccumulate_args = 1767,               /* -maccumulate-args */
  OPT_mbranch_cost_ = 1768,                  /* -mbranch-cost= */
  OPT_mcall_prologues = 1769,                /* -mcall-prologues */
  OPT_mdeb = 1770,                           /* -mdeb */
  OPT_mdouble_ = 1771,                       /* -mdouble= */
  OPT_mfract_convert_truncate = 1772,        /* -mfract-convert-truncate */
  OPT_mgas_isr_prologues = 1773,             /* -mgas-isr-prologues */
  OPT_mint8 = 1774,                          /* -mint8 */
  OPT_mlog_ = 1775,                          /* -mlog= */
  OPT_mlong_double_ = 1776,                  /* -mlong-double= */
  OPT_mmain_is_OS_task = 1777,               /* -mmain-is-OS_task */
  OPT_mmcu_ = 1778,                          /* -mmcu= */
  OPT_mn_flash_ = 1779,                      /* -mn-flash= */
  OPT_mno_interrupts = 1780,                 /* -mno-interrupts */
  OPT_morder1 = 1781,                        /* -morder1 */
  OPT_morder2 = 1782,                        /* -morder2 */
  OPT_mpmem_wrap_around = 1783,              /* -mpmem-wrap-around */
  OPT_mrelax = 1784,                         /* -mrelax */
  OPT_mrmw = 1785,                           /* -mrmw */
  OPT_mshort_calls = 1786,                   /* -mshort-calls */
  OPT_mskip_bug = 1787,                      /* -mskip-bug */
  OPT_msp8 = 1788,                           /* -msp8 */
  OPT_mstrict_X = 1789,                      /* -mstrict-X */
  OPT_mtiny_stack = 1790,                    /* -mtiny-stack */
  OPT_n = 1791,                              /* -n */
  ...
  OPT_nodevicelib = 1798,                    /* -nodevicelib */
  OPT_nodevicespecs = 1799,                  /* -nodevicespecs */
  ...
  OPT_static_libhwasan = 1845,               /* -static-libhwasan */
  ...
  OPT_std_c__23 = 1862,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1863, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1864, */                /* -std=c++2b */
  OPT_std_c__98 = 1865,                      /* -std=c++98 */
  OPT_std_c11 = 1866,                        /* -std=c11 */
  OPT_std_c17 = 1867,                        /* -std=c17 */
  /* OPT_std_c18 = 1868, */                  /* -std=c18 */
  /* OPT_std_c1x = 1869, */                  /* -std=c1x */
  OPT_std_c2x = 1870,                        /* -std=c2x */
  /* OPT_std_c89 = 1871, */                  /* -std=c89 */
  OPT_std_c90 = 1872,                        /* -std=c90 */
  OPT_std_c99 = 1873,                        /* -std=c99 */
  /* OPT_std_c9x = 1874, */                  /* -std=c9x */
  OPT_std_f2003 = 1875,                      /* -std=f2003 */
  OPT_std_f2008 = 1876,                      /* -std=f2008 */
  OPT_std_f2008ts = 1877,                    /* -std=f2008ts */
  OPT_std_f2018 = 1878,                      /* -std=f2018 */
  OPT_std_f95 = 1879,                        /* -std=f95 */
  OPT_std_gnu = 1880,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1881, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1882, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1883,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1884,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1885,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1886, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1887, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1888,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1889,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1890, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1891, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1892,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1893,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1894,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1895, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1896, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1897,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1898, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1899,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1900,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1901, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1902, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1903,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1904, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1905, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1906, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1907, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1908, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1909,                     /* -std=legacy */
  OPT_stdlib_ = 1910,                        /* -stdlib= */
